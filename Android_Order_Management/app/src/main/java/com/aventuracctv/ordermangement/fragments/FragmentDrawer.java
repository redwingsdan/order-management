...
import com.aventuracctv.ordermangement.adapters.NavigationDrawerAdapter;
import com.aventuracctv.ordermangement.data.DrawerItem;
...
public class FragmentDrawer extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // drawer labels
        titles = getResources().getStringArray(R.array.drawer_labels);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView.addItemDecoration(new HorizontalDividerItemDecoration.Builder(this.getActivity())
                .drawable(R.drawable.gradient_divider)
